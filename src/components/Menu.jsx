  ...
  return (
    <div className="w-full h-full flex flex-col items-center relative">
      ...
      <div className="w-full h-full flex flex-col justify-center overflow-hidden relative ">
        ...
        >
          <div className="w-[1098px] h-[1098px] rounded-full border-[2px] border-[#b0b0b051] flex items-center 
          justify-center  
           ">
            <div className="w-[949px] h-[949px] flex flex-row justify-center items-center overflow-hidden">
